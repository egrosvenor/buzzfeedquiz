...
def answer():
    ...
    if a>b and a>c and a>d:
        ...
        Label=tk.Label(master=window1, text="PDP boy/homeschooled girl. You enjoy long walks to the chapel and liturgy of the hours. Welcome to Franciscan!", height=12, width=12)
        Label.pack(side=tk.TOP, fill=tk.BOTH, expand=True)
        ...
        img2 = PhotoImage(file="new+evangelization.jpg")
        ...
        img3 = PhotoImage(file="new+evangelization.jpg")
        ...
        img4 = PhotoImage(file="new+evangelization.jpg")
        ...
        img5 = PhotoImage(file="new+evangelization.jpg")
